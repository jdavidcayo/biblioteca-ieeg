...
<div class="p-2">
    ...
    <main class="flex flex-wrap items-center justify-center p-4 bg-blanco">
        ...
        <div class="flex flex-col items-center justify-center bg-white rounded overflow-hidden shadow-md mb-4 mr-6">
            ...
            <button class="w-full bg-blanco text-morado border border-fucsia rounded-full font-gotham mb-2  hover:font-gothamBold hover:border-morado focus:font-gothamBold focus:border-morado ">DESCARGAR</button>
        </div>
